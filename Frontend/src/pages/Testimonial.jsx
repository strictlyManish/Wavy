...
const Testimonial = () => {
    ...
    const testimonials = [
  {
    id: 1,
    date: "Jun 10, 2026",
    text: "“This app completely changed how I discover new music. The sound quality and curated playlists are next level.”",
    name: "Liam Carter",
  ...
  },
  {
    id: 2,
    date: "Jun 15, 2026",
    text: "“As a producer, I love how smooth the interface feels. Managing tracks and sharing mixes has never been easier.”",
  ...
  },
  {
    id: 3,
    date: "Jun 22, 2026",
    text: "“The personalized recommendations are incredibly accurate. It feels like the app truly understands my vibe.”",
    name: "Noah Williams",
  ...
  },
  {
    id: 4,
    date: "Jul 05, 2026",
    text: "“Streaming is seamless and the UI is beautifully designed. My go-to platform for daily listening.”",
    name: "Ava Thompson",
  ...
  },
  {
    id: 5,
    date: "Jul 12, 2026",
    text: "“Uploading and promoting my tracks has never been this simple. This app truly supports upcoming artists.”",
    name: "Ethan Brooks",
        ...
        <>
            ...
            <section className='py-20 px-4 sm:px-6 lg:px-8'>
                <div className='w-full max-w-6xl mx-auto'>
                    <h1 className='text-neutral-100 font-medium text-4xl md:text-[40px] text-center md:text-left'>Loved by 10k+ People</h1>
                    <p className='text-neutral-400 text-sm/6 mt-4 max-w-96 text-center md:text-left mx-auto md:mx-0'>Every single testimonial is a testament to the profound impact we strive to create every single day.</p>
                    ...
                    <div className='mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-8 md:px-0 mt-12 md:mt-6'>
                        {testimonials.slice(currentIndex, isMobile ? currentIndex + 1 : currentIndex + 3).map((item) => (
                                <div key={item.id} className='bg-gray-900 hover:-translate-y-1 transition duration-300 rounded-2xl p-6 space-y-6'>
                                    ...
                                    <p className='text-sm/6 text-gray-400'>{item.text}</p>
